...
public class AppConstants {
	...
	public static final String REGISTRATION_SUCC_MSG = "Your Account Has Been Created";
	public static final String XL_SHEET_NAME = "register";
